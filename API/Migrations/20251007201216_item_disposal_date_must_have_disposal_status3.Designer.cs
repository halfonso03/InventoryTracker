...
namespace API.Migrations
{
    ...
    [Migration("20251007201216_item_disposal_date_must_have_disposal_status3")]
    partial class item_disposal_date_must_have_disposal_status3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Persistence.Models.Domain.Item", b =>
                {
                    ...
                    b.ToTable("Items", t =>
                        {
                            t.HasCheckConstraint("CK_Item_Disposal1", "[itemStatusId] = 4 AND  NOT [DisposalDate] IS NULL");

                            t.HasCheckConstraint("CK_Item_Disposal2", "[itemStatusId] != 4 AND  [DisposalDate] IS NULL");
                        });
                });
