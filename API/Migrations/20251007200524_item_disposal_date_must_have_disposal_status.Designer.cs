...
namespace API.Migrations
{
    ...
    [Migration("20251007200524_item_disposal_date_must_have_disposal_status")]
    partial class item_disposal_date_must_have_disposal_status
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Persistence.Models.Domain.Item", b =>
                {
                    ...
                    b.ToTable("Items", t =>
                        {
                            t.HasCheckConstraint("CK_Item_Disposal", "[itemStatusId] = 4 AND  NOT [DisposalDate] IS NULL");
                        });
                });
